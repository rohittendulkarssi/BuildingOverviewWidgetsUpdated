declare module "uxp/components" {
	...
	export interface ISelectProps {
		...
		selected: string;
		/**
		 * Option to pass a label for selected value,
		 * This will be used in the case if unable to find the selected item
		 */
		...
		/**
		 * Option to load paginated data in to the dropdown
		 * If this is given `options` passed above will be ignored
		 */
		getPaginatedOptions?: (
			max: number,
			lastToken: string,
			query?: string
		) => Promise<{ items: any[]; pageToken: string }>;

		/**
		 * number of options to load
		 * this will be used to paginate data
		 */
		pageSize?: number;
	...
	export interface DynamicFormFieldProps {
		...
		validate?: {
			...
			customValidateFunction?: (
				value: any,
				data: IFormData
			) => { valid: boolean; error?: string }; // this is to give a custom validate function, which takes the value and return a boolean indicating value is valid or not
		};
	}
	...
	export interface TableComponentProps {
		...
		data:
			| any[]
			| ((page: number, pageSize: number) => Promise<{ items: any[] }>);
		/**
		 * columns definitions
		 */
		columns: Column[];
	 ...
	 * @export
	 */
	export type IDataFunction = (
		max: number,
		lastPageToken: string,
		args?: any
	) => Promise<{ items: Array<any>; pageToken: string }>;
	 ...
	 */
	export type IDynamicSelectDataFunction = (
		max: number,
		lastPageToken: string,
		args?: any
	) => Promise<{ items: Array<any>; pageToken: string }>;
	 ...
	 *
	 */
	export type MessageBusHook = (
		context: IContextProvider,
		channel: string,
		callback: (payload: string, channel: string) => string
	) => void;

	/**
	 * @export
	 */
	export type FieldsHook = (
		fields: any
	) => [any, { [field: string]: (s: any) => void }, any, (s: any) => void];
	 ...
	 * @export
	 */
	export type RenderCustomFormView = (
		show: boolean,
		onClose: () => void,
		editInstance?: any
	) => React.ReactNode;
	 ...
	 * dropdown position
	 */
	export type IDropDownButtonPosition =
		| "right"
		| "left"
		| "top left"
		| "top right"
	...
	export const Input: React.ForwardRefExoticComponent<
		IInputProps & React.RefAttributes<IInputInstanceProps>
	>;
	...
	export const Checkbox: React.ForwardRefExoticComponent<
		ICheckboxProps & React.RefAttributes<ICheckboxInstanceProps>
	>;
	...
	export const DataList: React.ForwardRefExoticComponent<
		IDataListProps & React.RefAttributes<IDataListInstanceProps>
	>;
	 ...
	 * @export
	 */
	export const SearchBox: React.ForwardRefExoticComponent<
		ISearchBoxProps & React.RefAttributes<ISearchBoxInstanceProps>
	>;
	/**
	 * @export
	 */
	...
	export const TextArea: React.ForwardRefExoticComponent<
		ITextAreaProps & React.RefAttributes<ITextAreaInstanceProps>
	>;
	/**
	 * @export
	 */
	 ...
	 * @export
	 */
	export const AutoCompleteInput: React.ForwardRefExoticComponent<
		IAutoCompleteInputProps &
			React.RefAttributes<IAutoCompleteInputInstanceProps>
	>;
	/**
	 * @export
	 *
	 ...
	 *
	 */
	export const FileInput: React.ForwardRefExoticComponent<
		IFileInputProps & React.RefAttributes<IFileInputInstanceProps>
	>;
	/**
	 * @export
	 *
	 ...
	 * />
	 */
	export const LocalizationFormModal: React.ForwardRefExoticComponent<
		ILocalisationFormModalProps &
			React.RefAttributes<ILocalisationFormModalInstanceProps>
	>;
	/**
	 * @export
	 */
	 ...
	 * CRUD component
	 */
	export const CRUDComponent: React.ForwardRefExoticComponent<
		CRUDComponentProps & React.RefAttributes<CRUDComponentInstanceProps>
	>;
	/**
	 * @export
	 */
	 ...
	 */
	export const TreeViewSelectInput: React.ForwardRefExoticComponent<
		TreeViewSelectInputProps &
			React.RefAttributes<TreeViewSelectInputInstanceProps>
	>;
	export const useToast: ToastHook;
	export const useAlert: AlertHook;
	export const useUpdateWidgetProps: IUseUpdateWidgetProps;
	export const useDebounce: DebounceHook;
	export const useResizeEffect: ResizeEffectHook;
	export const useMessageBus: MessageBusHook;
	export const useFields: FieldsHook;
	export const useEffectWithPolling: IUseEffectWithPolling;
	export const useEventSubscriber: IEventSubscriber;
	export const eventDispatcher: IEventDispatcher;
}
